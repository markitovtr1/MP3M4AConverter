...
public class TagWriterTest {
	...
	public void setUp() throws Exception {
		tagWriter = new TagWriter(TEST_TAGS, audioFileIOMock);
	}
	...
	public void test_whenFilesWithoutProblems_ArtworkIsWritten() throws Exception {
		...
		PowerMockito.mockStatic(Artwork.class);
		when(Artwork.createArtworkFromFile(TEST_ARTWORK_PATH.toFile())).thenReturn(artworkMock);
